...
class PyI25:
    ...
    def GenerarImagen(self, codigo, archivo="barras.png",
        ...
        "Generar una imagen con el codigo de barras Interleaved 2 of 5"
        # basado de:
        ...
        # codigos ancho/angostos (wide/narrow) para los digitos
        ...
        # agregar codigos de inicio y final
        ...
        xpos = 0
        # dibujar los codigos de barras
        for i in range(0, len(codigo), 2):
            # obtener el proximo par de digitos
            bar = ord(codigo[i]) - ord("0")
            space = ord(codigo[i + 1]) - ord("0")
            # crear la sequencia barras (1er digito=barras, 2do=espacios)
            seq = ""
    ...
    def DigitoVerificadorModulo10(self, codigo):
        "Rutina para el calculo del digito verificador 'modulo 10'"
        ...
        # Etapa 5: buscar el menor numero que sumado al resultado obtenido en
        # la etapa 4 de un numero multiplo de 10. Este sera el valor del digito
        # verificador del modulo 10.
