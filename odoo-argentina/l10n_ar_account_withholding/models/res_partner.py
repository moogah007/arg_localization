...
class ResPartner(models.Model):
    ...
    default_regimen_ganancias_id = fields.Many2many(
        'afip.tabla_ganancias.alicuotasymontos', 'res_afip', 'res_id', 'afip_id',
