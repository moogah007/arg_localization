...
class sales_reports(models.TransientModel):
    ...
    def Print_to_excel(self):
        ...
        if self.det_level == 'detailed':
            ...
            subindex += 1
            worksheet.write(index,subindex,_('Percepcion de Ganancias sufridas'))
            subindex += 1
        ...
        for o in invoices:
            if o.journal_id.use_documents and o.validated_inv(self):
                ...
                if self.det_level == 'detailed':
                    ...
                    tot = sum(o.tax_line_ids.filtered(lambda r: (
                                r.tax_id.tax_group_id.type == 'perception' and
                                r.tax_id.tax_group_id.tax == 'profits') and
                                r.tax_id.tax_group_id.application == 'national_taxes').mapped('amount'))
                    worksheet.write(index, subindex, tot)
                    cgp_total += tot
                    subindex += 1
        ...
        if self.det_level == 'detailed':
            ...
            subindex += 1
            worksheet.write(index, subindex, cgp_total)
            subindex += 1
