    ...
    def doit(self):
        ...
        if self.type == 'supplier':
            list_titles = [
                ...
                _('Withholding Certificate No'),
                _('Withholding Tax'),
                _('Withholdable Amount'),
                _('Withholding Rate'),
                _('Withholding Value'),
                _('MB1 Amount'),
            ]
        ...
        if payments:
            ...
            for pay in payments:
                ...
                if not pay.partner_id.main_id_number in lines.keys():
                    ...
                    if self.type == 'supplier':
                        lines.update({key: [
                            pay.partner_id.main_id_number,
                            pay.partner_id.name,
                            pay.partner_id.afip_responsability_type_id.name,
                            pay.partner_id.gross_income_type,
                            pay.partner_id.gross_income_number,
                            pay.payment_group_id.display_name,
                            pay.vendorbill.display_name2,
                            pay.withholding_number,
                            pay.tax_withholding_id.name,
                            pay.withholding_base_amount,
                            pay.wh_perc, pay.amount,
                    ...
                    if self.type == 'customer':
                        lines.update({key: [
                            ...
                            pay.partner_id.gross_income_number,
                            pay.payment_group_id.display_name,
                            pay.customerbill.display_name2,
                            pay.withholding_number,
                            pay.tax_withholding_id.name,
                            pay.withholding_base_amount,
                            pay.wh_perc, pay.amount,
