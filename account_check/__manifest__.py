...
##############################################################################
{
    'name': 'Account Check Management 2.0',
    'version': '10.0.2.0.22',
    'category': 'Accounting',
    'summary': 'Accounting, Payment, Check, Third, Issue 2.0',
    'author': 'OpenERP Team de Localizacion Argentina, Odoo Community Association (OCA), Bacgroup',
    'license': 'AGPL-3',
    'images': [
    ],
    'depends': [
